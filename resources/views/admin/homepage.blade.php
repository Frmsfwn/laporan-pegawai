...
<head>
    ...
    <title>{{ config('app.name') }} | Admin | Homepage</title>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row justify-content-between text-left mb-2">
                                            <div class="col-sm-12 flex-column d-flex ">
                                                ...
                                                <input type="text" id="nama_kegiatan" name="nama_kegiatan" @if($errors->hasBag('tambah_data')) value="{{ old('nama_kegiatan') }}" @endif min="" maxlength="50" class="form-control @error('nama_kegiatan', 'tambah_data') is-invalid @enderror" @required(true)>
